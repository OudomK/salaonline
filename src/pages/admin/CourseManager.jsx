...
import VideoManagementModal from './LessonManager/components/VideoManagementModal';
...
export default function CourseManager() {
   ...
   const [selectedCourseVideo, setSelectedCourseVideo] = useState(null);
                        ...
                        <tr key={course.id} className="hover:bg-gray-50/80 transition-colors">
                           ...
                           <td className="px-6 py-4 text-center">
                              <div className="flex justify-center gap-2">
                                 ...
                                 <button onClick={() => handleOpenVideoManager(course)} className="p-2 rounded-lg bg-indigo-50 text-indigo-500 hover:bg-indigo-500 hover:text-white transition-all" title="Manage Videos"><Video size={16} /></button>
