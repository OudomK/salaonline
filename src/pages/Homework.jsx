...
// import { CloudUpload, Mic, Square, Trash2, CheckCircle, ChevronLeft } from "lucide-react";
...
//       setIsRecording(true);
//     } catch (err) {
//       alert("សូមអនុញ្ញាតឱ្យប្រើ Microphone ដើម្បីថតសំឡេង!");
//     }
//   };
...
//       alert("សូម Upload រូបភាព ឬ ថតសំឡេងជាមុនសិន!");
//       return;
//     }
//     setTimeout(() => {
//       setIsSubmitted(true);
...
//            className="w-full max-w-xs bg-[#00B4F6] text-white font-bold py-3.5 rounded-xl shadow-lg"
//         >
//            Back to Lesson
//         </button>
//       </div>
...
//   return (
//     <div className="min-h-screen bg-[#f8f9fa] flex flex-col md:py-10">
